...
export const getAuthorizerCompileResponseMock = (overrideResponse: Partial< V2CompileResponse > = {}): V2CompileResponse => ({metrics: faker.helpers.arrayElement([{}, undefined]), result: faker.helpers.arrayElement([{}, undefined]), trace: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ max: 10, min: 1 }) }, (_, i) => i + 1).map(() => ({})), undefined]), trace_summary: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ max: 10, min: 1 }) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {max: 20, min: 10}}))), undefined]), ...overrideResponse})

export const getAuthorizerDecisionTreeResponseMock = (overrideResponse: Partial< V2DecisionTreeResponse > = {}): V2DecisionTreeResponse => ({path: faker.helpers.arrayElement([{}, undefined]), path_root: faker.helpers.arrayElement([faker.string.alpha({length: {max: 20, min: 10}}), undefined]), ...overrideResponse})

export const getAuthorizerIsResponseMock = (overrideResponse: Partial< V2IsResponse > = {}): V2IsResponse => ({decisions: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ max: 10, min: 1 }) }, (_, i) => i + 1).map(() => ({decision: faker.helpers.arrayElement([faker.string.alpha({length: {max: 20, min: 10}}), undefined]), is: faker.helpers.arrayElement([faker.datatype.boolean(), undefined])})), undefined]), ...overrideResponse})

export const getAuthorizerQueryResponseMock = (overrideResponse: Partial< V2QueryResponse > = {}): V2QueryResponse => ({metrics: faker.helpers.arrayElement([{}, undefined]), response: faker.helpers.arrayElement([{}, undefined]), trace: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ max: 10, min: 1 }) }, (_, i) => i + 1).map(() => ({})), undefined]), trace_summary: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ max: 10, min: 1 }) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {max: 20, min: 10}}))), undefined]), ...overrideResponse})

export const getInfoGetResponseMock = (overrideResponse: Partial< V2InfoResponse > = {}): V2InfoResponse => ({arch: faker.helpers.arrayElement([faker.string.alpha({length: {max: 20, min: 10}}), undefined]), commit: faker.helpers.arrayElement([faker.string.alpha({length: {max: 20, min: 10}}), undefined]), date: faker.helpers.arrayElement([faker.string.alpha({length: {max: 20, min: 10}}), undefined]), os: faker.helpers.arrayElement([faker.string.alpha({length: {max: 20, min: 10}}), undefined]), version: faker.helpers.arrayElement([faker.string.alpha({length: {max: 20, min: 10}}), undefined]), ...overrideResponse})

export const getPoliciesListResponseMock = (overrideResponse: Partial< V2ListPoliciesResponse > = {}): V2ListPoliciesResponse => ({result: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ max: 10, min: 1 }) }, (_, i) => i + 1).map(() => ({ast: faker.helpers.arrayElement([{}, undefined]), id: faker.helpers.arrayElement([faker.string.alpha({length: {max: 20, min: 10}}), undefined]), package_path: faker.helpers.arrayElement([faker.string.alpha({length: {max: 20, min: 10}}), undefined]), package_root: faker.helpers.arrayElement([faker.string.alpha({length: {max: 20, min: 10}}), undefined]), raw: faker.helpers.arrayElement([faker.string.alpha({length: {max: 20, min: 10}}), undefined])})), undefined]), ...overrideResponse})

export const getPoliciesGetResponseMock = (overrideResponse: Partial< V2GetPolicyResponse > = {}): V2GetPolicyResponse => ({result: faker.helpers.arrayElement([{ast: faker.helpers.arrayElement([{}, undefined]), id: faker.helpers.arrayElement([faker.string.alpha({length: {max: 20, min: 10}}), undefined]), package_path: faker.helpers.arrayElement([faker.string.alpha({length: {max: 20, min: 10}}), undefined]), package_root: faker.helpers.arrayElement([faker.string.alpha({length: {max: 20, min: 10}}), undefined]), raw: faker.helpers.arrayElement([faker.string.alpha({length: {max: 20, min: 10}}), undefined])}, undefined]), ...overrideResponse})
